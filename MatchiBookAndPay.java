...
public class MatchiBookAndPay extends MatchiSearchBaseline{
	...
	public static void payCourtByCard(String string, String string2, String string3) {
		...
		WebElement element2 = webDriver.findElement(By.xpath("//input[@id='btnSubmit']"));
		element2.click();
		WebElement KortNamn = webDriver.findElement(By.xpath("//input[@placeholder='För- och efternamn']"));
		KortNamn.click();
		...
		WebElement KortNummerField = webDriver.findElement(By.xpath("//input[@placeholder='Kortnummer']"));
