...
public class MatchiBookAndPay extends MatchiSearchBaseline{
	...
	public static void payCourtByCard(String string, String string2, String string3) {
		...
		WebElement element4 = webDriver.findElement(By.xpath("//input[@placeholder='F�r- och efternamn']"));
		element4.click();
		...
		element7.click();
		WebElement element8 = webDriver.findElement(By.xpath("//input[@value='Slutf�r betalning']"));
		element8.click();	
	}
