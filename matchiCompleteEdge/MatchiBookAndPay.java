...
public class MatchiBookAndPay extends MatchiSearchBaseline{
	...
	public static void payCourtByCard(String string, String string2, String string3) {
		...
		js.executeScript("arguments[1].value = arguments[0]; ", string, element3); 
		
		//WebElement element4 = webDriver.findElement(By.xpath("//input[@placeholder='För- och efternamn']"));
		WebElement element4 = webDriver.findElement(By.xpath("//*[@id=\"adyen-encrypted-form\"]/div[1]/div/div/div[2]/div[2]/input"));
		element4.click();
		element4.sendKeys(string2);
		//*[@id="adyen-encrypted-form"]/div[1]/div/div/div[2]/div[2]/input
		delay(2000);
		...
		WebElement element8 = webDriver.findElement(By.xpath("//*[@id=\"adyen-encrypted-form\"]/div[2]/input"));
		element8.click();	
		//*[@id="adyen-encrypted-form"]/div[2]/input
	}
