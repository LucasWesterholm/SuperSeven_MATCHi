...
public class MatchiSearchVenue extends MatchiSearchBaseline {
 ...
 */
	public static void searchSportViaMyProfile() {
		WebElement element = webDriver.findElement(By.xpath("//button[@title='Select sport']")); 
		element.click();
	}
 ...
 */
	...
	/**
	 * Chooses the first result in the list of venues
	 *
	 */
	public static void chooseVenueFirstResultEDGE() {
		WebElement element = webDriver.findElement(By.className("text-black weight400"));
		element.click();
		}
