...
public class MatchiSearchMonthDayTime {
	private WebDriver webDriver;

		public MatchiSearchMonthDayTime() {
	...
	/**
	 * Select displayed Venue result via Book
	 */
	...
	/**
	 * Select the desired time on "Anl�ggningar" (time selected is 18:00)	
	 */
		public void selectTimeInVenues() {
			JavascriptExecutor js = (JavascriptExecutor) webDriver;
